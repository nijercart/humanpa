...
### 7. UI
- Need page shows provenance: "Answered from X saved sources + Y new" and per-source "fetched N days ago".
- Quota line explains that reusing existing knowledge is free.
